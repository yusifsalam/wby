...
func (f fakeWeatherService) GetPrecipitationOverlay(ctx context.Context, req weather.PrecipitationOverlayRequest) (*weather.PrecipitationOverlay, error) {
	panic("not used in this test")
}
...
func (f fakeWeatherService) GetPrecipitationObservationGrid(ctx context.Context, req weather.PrecipitationOverlayRequest) (*weather.PrecipitationForecastGrid, error) {
	panic("not used in this test")
}

func (f fakeWeatherService) GetPrecipitationNowcastGrid(ctx context.Context, req weather.PrecipitationOverlayRequest) (*weather.PrecipitationForecastGrid, error) {
	panic("not used in this test")
}
